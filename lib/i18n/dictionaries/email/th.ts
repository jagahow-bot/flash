...
const email: EmailDictionary = {
  ...
  studioWelcome: {
    title: "ยินดีต้อนรับสู่ FLASH",
    body: "สวัสดี {studioName}\n\nสตูดิโอของคุณตั้งค่าเสร็จแล้ว FLASH ช่วยแปลงคำขอของลูกค้าเป็นสรุปที่มีโครงสร้าง จัดการใบเสนอราคา และติดตามการจองทุกรายการ",
    nextStepsTitle: "ขั้นตอนถัดไปที่แนะนำ",
    nextSteps:
      "• เชิญช่างสักเข้าทีม\n• เพิ่มแฟลชดีไซน์ในหน้าร้าน\n• แชร์ลิงก์หน้าจองให้ลูกค้า\n• ตรวจสอบการตั้งค่าสตูดิโอและข้อมูลการชำระเงิน",
    dashboardButton: "เปิดแดชบอร์ด",
    bookingPageButton: "ดูหน้าจอง",
  },
